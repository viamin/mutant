        ...
        class Text < self
          ...
          class ASTToExpression < Transformer::ASTToExpression
            ...
            TABLE = Table.create(
              ...
              [:regexp_number_call_backref, %i[backref number_call], ::Regexp::Expression::Backreference::NumberCall],
              [:regexp_number_recursion_ref_backref, %i[backref number_recursion_ref], ::Regexp::Expression::Backreference::NumberRecursionLevel],
              [:regexp_number_rel_ref_backref, %i[backref number_rel_ref], ::Regexp::Expression::Backreference::NumberRelative],
              [:regexp_number_rel_call_backref, %i[backref number_rel_call], ::Regexp::Expression::Backreference::NumberCallRelative],
              [:regexp_name_call_backref, %i[backref name_call], ::Regexp::Expression::Backreference::NameCall],
              [:regexp_name_ref_backref, %i[backref name_ref], ::Regexp::Expression::Backreference::Name],
              [:regexp_name_recursion_ref_backref, %i[backref name_recursion_ref], ::Regexp::Expression::Backreference::NameRecursionLevel],
              ...
              [:regexp_utf8_hex_escape,       %i[utf8_hex escape],       ::Regexp::Expression::EscapeSequence::UTF8Hex],
