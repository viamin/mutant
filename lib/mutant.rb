...
require 'mutant/mutator/node/hash_pattern'
require 'mutant/mutator/node/array_pattern'
require 'mutant/mutator/node/array_pattern_with_tail'
...
require 'mutant/cli/session/presenter'
